...
<% ArrayList <String> transactionNumber = (ArrayList<String>) session.getAttribute("transactionNumber"); %> 
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<body>
	...
	<div>
		<h2 align="center">Latest Transactions</h2>
	</div>
	<div align="center"> <br>
		<table class="trantable" >
			...
			<tbody>
				<c:forEach items="${transactionNumber}" var="tran"> 
